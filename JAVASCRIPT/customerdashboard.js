...
(function() {
    ...
    $(document).ready(function() {
        ...
        function fetchCustomerInfo() {
            ...
            if (customerId) {
                $.ajax({
                    url: `https://firestore.googleapis.com/v1/projects/onlineshop-a90a1/databases/(default)/documents/Customer/${customerId}`,
                    type: 'GET',
        ...
        $.ajax({
            url: 'https://firestore.googleapis.com/v1/projects/onlineshop-a90a1/databases/(default)/documents/Inventory',
            type: 'GET',
            success: function(response) {
                    ...
                    inventoryItems.forEach(inventoryItem => {
                        ...
                        if (cartProduct) {
                            ...
                            if (newQuantity >= 0) {
                                ...
                                $.ajax({
                                    url: `https://firestore.googleapis.com/v1/projects/onlineshop-a90a1/databases/(default)/documents/Inventory/${inventoryId}`,
                                    type: 'PATCH',
        ...
        function createOrder() {
            ...
            if(customerId){
                ...
                $.ajax({
                    url: 'https://firestore.googleapis.com/v1/projects/onlineshop-a90a1/databases/(default)/documents/Purchase',
                    type: 'POST',
                    contentType: 'application/json',
